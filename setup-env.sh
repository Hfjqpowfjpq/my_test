...
base_path = "/root/my_tests"

# Update and Upgrade
sudo apt update && sudo apt -y upgarde
...
source $base_path/kayobe/bin/activate
pip install -U pip
...
source $base_path/tenks/bin/activate
pip install -U pip
cd $base_path/tenks
pip install .
...
source $base_path/kayobe/bin/activate
source $base_path/src/kayobe-config/kayobe-env
